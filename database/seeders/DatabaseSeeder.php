    ...
    public function run(): void
    {
        ...
        DB::table('idea_images')->insert([
            [
                'id' => '1',
                'idea_id' => '1',
                'image_path' => 'public/storage/img/1_image1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => '2',
                'idea_id' => '2',
                'image_path' => 'public/storage/img/2_image1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => '3',
                'idea_id' => '3',
                'image_path' => 'public/storage/img/3_image1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => '4',
                'idea_id' => '4',
                'image_path' => 'public/storage/img/4_image1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => '5',
                'idea_id' => '5',
                'image_path' => 'public/storage/img/5_image1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
